...
STR_TABLE = {
    ...
    'quit': ('Quit', 'Quit', 'Lekker'),
    'connections': ('Verbindungen', 'Connections', 'Lekker'),
    'copy': ('Kopieren', 'Copy', 'Lekker'),
    'past': ('Einfügen', 'Past', 'Lekker'),
    ...
    'keybind': ('Tastaturbelegung', 'Keyboard layout', 'Lekker'),
    'about': ('Über', 'About', 'Lekker'),
    'help': ('Hilfe', 'Help', 'Lekker Hulp'),
    'minutes': ('Minuten', 'Minutes', 'Lekker'),
    'hours': ('Stunden', 'Hours', 'Lekker'),
    'day': ('Tag', 'Day', 'Lekker'),
    'month': ('Monat', 'Month', 'Lekker'),
    'occup': ('Auslastung in %', 'Occupancy in %', 'Lekker %'),
    ...
    'to': ('An', 'To', 'Lekker '),
    'versatz': ('Versatz', 'Offset', 'Lekker Offset'),
    ...
    'scrolling': ('Auto Scrollen', 'Auto scrolling', 'Lekker'),
    'multicast_warning': ('Vorsicht bei Nodenanbindungen wie TNN. Verlinkungen mehrerer Noden via Multicast kann zu Problemen führen!', 'Be careful with node connections like TNN. Linking multiple nodes via multicast can lead to problems!', 'Lekker problemen!'),
