...
class AX25Conn:
    ...
    """
    def send_remote_data(self, data: tuple, prio=False, is_abort_frame=False):
    ...
    # I/O Buffer Helper
    """
    def _clear_tx_buff_prp(self, opt_id):
        # PRP Remote Mon 
    ...
    def _clear_tx_buff_prp_rest(self, opt_id):
        # PRP ESC CLI 
    ...
    @property
    def get_state(self):
        return int(self.zustand_exec.stat_index)
