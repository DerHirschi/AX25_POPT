...
PORT_STATISTIK_IDX = "CREATE INDEX IF NOT EXISTS idx_portstat_port_time ON PortStatistic(port_id, time);\n"
SQLITE_PORT_STATISTIK_IDX = "CREATE INDEX IF NOT EXISTS idx_portstat_port_time ON PortStatistic(port_id, time);\n"
