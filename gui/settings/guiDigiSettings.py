...
class DIGI_cfg_Tab(ttk.Frame):
    def __init__(self, root_win, digi_settings: dict):
        ...
        digi_chk = ttk.Checkbutton(opt_frame_0,
                                          text='DIGI',
        ...
        ##################
        # Managed DIGI
        self._managed_digi_chk = ttk.Checkbutton(opt_frame_0,
                                          text='L3-DIGI',
        ...
        ##################
        self._short_via_ent = ttk.Checkbutton(opt_frame_2,
                                             text='Short VIAs ',
                                             variable=self._short_via_calls)
        self._short_via_ent.pack(side=tk.LEFT, padx=5, pady=5, anchor=tk.W)
        self._UI_short_via_ent = ttk.Checkbutton(opt_frame_2,
        ...
        ##################
        ttk.Label(opt_frame_3, text='MAX Buffer till RNR: ').pack(side=tk.LEFT, padx=5)
        self._max_buff_ent = ttk.Spinbox(opt_frame_3,
        ...
        ttk.Label(opt_frame_3, text='Bytes').pack(side=tk.LEFT, padx=5)
        ##################################################################
        opt_frame_4 = ttk.Frame(self)
        opt_frame_4.pack(fill=tk.X, padx=5, pady=5)
        ##################
        ttk.Label(opt_frame_4, text='MAX N2 till RNR: ').pack(side=tk.LEFT, padx=5)
        self._max_n2_ent = ttk.Spinbox(opt_frame_4,
        ...
        ##################################################################
        opt_frame_5 = ttk.Frame(self)
        opt_frame_5.pack(fill=tk.X, padx=5, pady=5)
        ##################
        ttk.Label(opt_frame_5, text='last SABM RX Fail').pack(side=tk.LEFT, padx=5)
        self._max_SABM_ent = ttk.Spinbox(opt_frame_5,
        ...
        ttk.Label(opt_frame_5, text='Sec').pack(side=tk.LEFT, padx=5)
        ###################################################################
        ###################################################################
        ###################################################################
...
class DIGI_SettingsWin(ttk.Frame):
