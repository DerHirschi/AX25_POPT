...
STR_TABLE = {
    ...
    'new': ('Neu', 'New', 'Nieuw'),
    'new_port': ('Neuer Port', 'New port', 'Nieuwe Port'),
    ...
    'port_cfg_std_parm': ('Standard Parameter. Werden genutzt wenn nirgendwo anders (Station/Client) definiert.', 'Default parameters. Are used if not defined anywhere else (station/client).', 'Standaardparameters. Worden gebruikt als ze nergens anders zijn gedefinieerd (station/client).'),
    'port_cfg_psd_txd': ('Pseudo TX-Delay (Wartezeit zwischen TX und RX). Wird nicht als KISS Parameter am TNC gesetzt.', 'Pseudo TX delay (waiting time between TX and RX). Is not set as a KISS parameter on the TNC.', 'Pseudo TX-vertraging (wachttijd tussen TX en RX). Is op de TNC niet als KISS-parameter ingesteld.'),
    'port_cfg_pac_len': ('Paket Länge. 1 - 256', 'Packet length. 1-256', 'Pakket lengte. 1-256'),
    'port_cfg_pac_max': ('Max Paket Anzahl. 1 - 7', 'Max Packets. 1 - 7', 'Max pakketnummer. 1 - 7'),
    'port_cfg_port_name': ('Port Bezeichnung für MH und Monitor( Max: 4 ):', 'Port designation for MH and monitor (Max: 4):', 'Poortaanduiding voor MH en monitor (Max: 4):'),
    'port_cfg_not_init': ('!! Port ist nicht Initialisiert !!', '!! Port is not initialized!!', '!! Poort is niet geïnitialiseerd!!'),
