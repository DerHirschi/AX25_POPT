...
STR_TABLE = {
    ...
    'bbs_new_user_reg_confirm': (
        ...
        'Pressione <Enter> para confirmar ou digite novamente para alterar.\r>',
    ...
    'bbs_new_user_reg1': (
        ...
        ('\r'
         ...
         'Imię               :'),
        ('\r'
         'Esta é a primeira ligação a este sistema.\r'
    ...
    'bbs_new_user_reg2_1': (
        ...
        '{} \r ainda é a sua BBS de origem atual? S/N> ',
    ...
    'bbs_new_user_reg2_2': (
        ...
        'Usar esta BBS como BBS de origem? S/N> ',
    ...
    'bbs_new_user_error_hbbs_add': (
        ...
        '\r # Erro, o call inserido não é uma BBS.\r # {} Tipo conhecido como {}.\r # Tente novamente.\r\r',
    ...
    'bbs_new_user_sysopMsg_msg': (
        ...
        '{} acabou de se conectar a {} pela primeira vez.\nHora: {}\n',
    ...
    'userdb_del_hint2_2': (
        ...
        'Realmente eliminar todas as {} entradas?',
    ...
    'call_vali_warning_2': (
        ...
        'Máx. 6 caracteres, apenas letras maiúsculas e números.',
    ...
    'del_station_warning_2': (
        ...
        'Drive C: foi formatado com sucesso.',
    ...
    'not_all_station_disco_hint_2': (
        ...
        'Nem todas as estações foram desconectadas!',
    ...
    'all_station_get_disco_hint_1': (
        ...
        'Estações a serem desconectadas!',
    ...
    'all_station_get_disco_hint_2': (
        ...
        'Todas as estações serão desconectadas',
    ...
    'port_in_use': (
        ...
        'Erro: Não foi possível inicializar a porta {}. Porta já em uso.',
    ...
    'port_reinit': (
        ...
        'Info: Porta {} sendo reinicializada.',
    ...
    'all_disco1': (
        ...
        'Stanice se odpojují!',
        'Stacje są rozłączane!',
        'Estações estão sendo desconectadas!',
        'Le stazioni vengono disconnesse!',
        'Станции отключаются!',
        'Станції відключаються!'),
    ...
    'all_disco2': (
        ...
        'Všechny stanice se odpojují',
        'Wszystkie stacje są rozłączane',
        'Todas as estações estão sendo desconectadas',
        'Tutte le stazioni vengono disconnesse',
        'Все станции отключаются',
        'Всі станції відключаються'),
    ...
    'disconnect_all_ask': (
        ...
        'Deseja realmente desconectar TODAS as estações?',
    ...
    'invalid_axcall_warning2': (
        ...
        'O Call inserido está incorreto.',
    ...
    'cli_text_encoding_set': (
        ...
        ' # Umlauty/kódování textu rozpoznáno a nastaveno na:',
        ' # Kodowanie tekstu wykryte i ustawione na:',
        ' # Codificação de texto detetada e definida para:',
        ' # Codifica testo rilevata e impostata su:',
        ' # Кодировка текста распознана и установлена на:',
        ' # Кодування тексту розпізнано та встановлено на:'),
    ...
    'cmd_help_chist': (
        ...
        'Histórico de ligações (últimos 30 dias)',
    ...
    'cli_no_lang_param': (
        ...
        'Idioma não reconhecido! Idiomas possíveis: ',
    ...
    'losche_Port_msg': (
        ...
        ('Tem certeza que deseja apagar este port? \n'
    ...
    'invalid_call_msg': (
        ...
        'O call do Sysop inserido é inválido',
    ...
    'new_user_std_level': (
        ...
        'Nível padrão para novos usuários:',
