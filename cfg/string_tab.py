...
STR_TABLE = {
    ...
    'port_plot_horizontal_bar': (
        'Horizontales Balken',
        'Horizontal Bar',
        'Horizontale Staaf',
        'Barre Horizontale',
        'Horizontální Sloupec',
        'Słupek Poziomy',
        'Barra Horizontal',
        'Barra Orizzontale',
        'Горизонтальная',
